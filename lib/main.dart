        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(onPressed: (){
              setState(() {
               if(flag){
                ...
                child: Text('Animation',style: TextStyle(fontSize: 15,fontWeight: FontWeight.w500,),)),
            AnimatedOpacity(
              opacity: myOpac,
            ...
            Center(
              child: InkWell(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => detailPg(),));
                },
                child: Container(
                  height: 100,
            ...
            ElevatedButton(onPressed: (){
              Navigator.push(context, MaterialPageRoute(builder: (context) => listPg(),));
            }, child: Text('3D List'))
          ],
        ),
      ) 
